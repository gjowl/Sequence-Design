        ...
        for mutant_cutoff in mutant_cutoffs:
            for percent_cutoff in percent_cutoffs:
                ...
                for filename in os.listdir(clashOutputDir):
                    ...
                    execAnalyzeclash = f'python3 {scriptDir}/combineFilesAndPlot_designEnergies.py -seqFile {clashOutputDir}/{filename} -energyFile {outputDir}/{maltosePassingFile}.csv -outDir {file_outputDir} -percentCutoff {percent_cutoff} -codeDir {scriptDir}'
