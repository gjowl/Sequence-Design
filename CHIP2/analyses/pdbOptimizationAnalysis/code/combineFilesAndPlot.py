...
sequence_df = sequence_df[['Sequence','PercentGpA_transformed','std_adjusted']] #TODO add more to carry over including the diffs; which for some reason are getting calcd again?
