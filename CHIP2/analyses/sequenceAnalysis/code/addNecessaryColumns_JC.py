...
df_all['pos_wtAA'] = df_all['Position'].astype(str) + df_all['WT_AA']
df_all['pos_mutAA'] = df_all['Position'].astype(str) + df_all['mut_AA']
df_all['WT_MUT'] = df_all['WT_AA'] + df_all['mut_AA']
