...
config = globalConfig['figureMaking']
...
optimizedPdbDirLeu = config['optimizedPdbDirLeu'] # where the pdbs for the sequences are located
optimizedPdbDirAla = config['optimizedPdbDirAla'] # where the pdbs for the sequences are located
