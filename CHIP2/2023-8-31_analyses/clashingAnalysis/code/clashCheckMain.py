...
codeDir = f'/mnt/d/github/Sequence-Design/CHIP2/2023-8-31_analyses/clashingAnalysis/code'
graphDir = f'/mnt/d/github/Sequence-Design/CHIP2/fluorescenceAnalysis/code'
...
for index, row in df.iterrows():
    ...
    outputDir = f'{cwd}/clash_atLeastOneMutant_maltosePassing/wt_{wt_cutoff}_mutant_{mutant_cutoff}'
    ...
    execGraphComputationVsExperiment = f'python3 {graphDir}/graphComputationVsExperiment.py {outputDir}/wtGreaterThanMutant.csv {outputDir}'
