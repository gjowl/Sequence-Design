...
and selects from a desired subset of sequences to setup a CHIP to order
-This version does not allow for repeat choices of sequences in each segment
"""
# Variables
outputDir = "C:\\Users\\gjowl\\Documents\\Senes Lab\\Design Research\\Sequence Design\\Analysis\\"
outputFile = outputDir + 'optimizedBackboneAnalysis_noRedundant.xlsx'
...
filename = 'Design Energies After Backbone Optimization nonredundant'
listDf = dfDesign
