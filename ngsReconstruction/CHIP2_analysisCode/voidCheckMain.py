...
for index, row in df.iterrows():
    ...
    outputDir = f'{cwd}/void_atLeastOneMutant_highestPercentWt/wt_{wt_cutoff}_mutant_{mutant_cutoff}_percent_{percent_cutoff}'

    execClashCheck = f'python3 {codeDir}/checkVoidMutants.py {sequenceFile} {mutantFile} {outputDir} {wt_cutoff} {mutant_cutoff} {percent_cutoff}'
