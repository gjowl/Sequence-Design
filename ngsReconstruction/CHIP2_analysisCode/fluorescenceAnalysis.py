...
for sample in samples:
    ...
    # TODO: add in a standard deviation cutoff here
    df_sample = df_sample[df_sample['std'] < std_dev_cutoff]
    df_sample = df_sample[df_sample[maltose_col] > maltose_cutoff]
    ...
    df_pie = pd.DataFrame({'< G83I': lessThanG83i, '> GpA': moreThanGpa, 'G83I > sample > GpA': rest}, index=[0])
