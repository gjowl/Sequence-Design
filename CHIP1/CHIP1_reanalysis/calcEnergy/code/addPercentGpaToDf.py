...
toxgreenDf = toxgreenDf[['Sequence','PercentGpa','PercentGpaStdDev']]
...
toxgreenDf['Sequence'] = toxgreenDf['Sequence'].str[3:-3] # removes the first 3 and last 3 characters from the geometry column
...
df.to_csv(f'{outputFile}', sep=',', index=False)